...
// PS-X object/normal space is Y-down; negate Y once here so the (Y-up)
// preview camera shows things upright - same convention as
// tmd_panel.cpp/tmd_object_renderer.cpp.
