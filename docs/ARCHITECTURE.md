...
| [nativefiledialog-extended (nfd)](https://github.com/btzy/nativefiledialog-extended) | pinned commit past tag `v1.3.0` (upstream's main branch) | zlib | Native OS open/save file dialogs. On Linux this builds against GTK3 and Wayland client dev packages - see the README's build instructions. |
